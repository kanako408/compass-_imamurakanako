    ...
    <div class="top_area w-75 m-auto pt-5">
      ...
      <div class="user_status p-3">
        ...
        <div class="subject_header">
          @can('admin')
          <span class="" style="color: #03aad2;">選択科目の登録</span>
          <span class="subject_edit_btn toggle-arrow"></span>
        </div>
        <div class="subject_inner">

          <form action="{{ route('user.edit') }}" method="post" class=subject_inner_form>
