        ...
        <div class="vh-75 border p-5 form-group" style="width: 500px;">
          ...
          <div class="mt-3 p-1">
            <div style="display: flex; justify-content: center;">
              ...
              <label style="font-size:13px ;padding-right: 60px;">
                ...
                女性</label>
              <label style="font-size:13px;padding-right: 0px;">
          ...
          <div class="mt-3">
            ...
            <div class="d-flex justify-content-between flex-wrap">
              <select class="custom-select2 old_year" name="old_year">
              ...
              <select class="custom-select2 old_month" name="old_month">
                <option value="none">-----</option>
              ...
              <select class="custom-select2 old_day" name="old_day">
                <option value="none">-----</option>
                <option value="01">1</option>
                <option value="02">2</option>
                <option value="03">3</option>
